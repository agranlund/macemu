...
#define MENU_GFX_MODE_CUR                 43 /* STRING in tree MENU_MAIN */
#define MENU_GFX_MODE_1B                  44 /* STRING in tree MENU_MAIN */
#define MENU_GFX_MODE_4B                  45 /* STRING in tree MENU_MAIN */
#define MENU_GFX_MODE_8B                  46 /* STRING in tree MENU_MAIN */
#define MENU_GFX_MODE_16B                 47 /* STRING in tree MENU_MAIN */
